...
joint.shapes.uml.Class = joint.shapes.basic.Generic.extend({
    ...
    defaults: joint.util.deepSupplement({
        ...
        attrs: {
            ...
            '.uml-class-name-rect': { 'stroke': 'black', 'stroke-width': 1, 'fill': '#666666' },
            '.uml-class-attrs-rect': { 'stroke': 'black', 'stroke-width': 1, 'fill': '#999999' },
            '.uml-class-methods-rect': { 'stroke': 'black', 'stroke-width': 1, 'fill': '#999999' },

            '.uml-class-name-text': {
                'ref': '.uml-class-name-rect', 'ref-y': 0.5, 'ref-x': .5, 'text-anchor': 'middle', 'y-alignment': 'middle', 'font-weight': 'bold',
                'fill': 'white', 'font-size': 12, 'font-family': 'Arial'
            },
            '.uml-class-attrs-text': {
                'ref': '.uml-class-attrs-rect', 'ref-y': 0.5, 'ref-x': 5, 'y-alignment': 'middle', 
                'fill': 'white', 'font-size': 11, 'font-family': 'Arial'
            },
            '.uml-class-methods-text': {
                'ref': '.uml-class-methods-rect', 'ref-y': 0.5, 'ref-x': 5, 'y-alignment': 'middle', 
                'fill': 'white', 'font-size': 11, 'font-family': 'Arial'
            }
        },
